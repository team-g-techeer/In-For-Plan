...
public class UserService {
    ...
    @Transactional
    public Users create(UserRequestDto userRequestDto) throws InvalidAlgorithmParameterException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException {
